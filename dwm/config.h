...
static const char *fonts[]          = { "Mononoki NerdFont:size=11" };
static const char dmenufont[]       = "Mononoki NerdFont:size=11";
static const char col_gray1[]       = "#1E1E2E";
static const char col_gray2[]       = "#1E1E2E";
static const char col_gray3[]       = "#bbbbbb";
static const char col_gray4[]       = "#c6d0f5";
static const char col_accent[]        = "#81c8be";
...
static const char *colorpicker[] = { "colorpicker", NULL };
...
static const Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_p,      spawn,          {.v = colorpicker } },
  ...
  { MODKEY|ShiftMask,             XK_Up,     spawn,          {.v = incVol } },
  { MODKEY|ShiftMask,             XK_Down,   spawn,          {.v = decVol } },
